...
export const ProjectCard = ({ title, description, imgSrc, href }) => (
  <Link
    ...
    className="w-full max-w-xl lg:max-w-5xl h-full overflow-hidden shadow-md hover:shadow-xl focus:shadow-xl transition rounded-xl bg-white dark:bg-gray-800"
  >
    <Image
      alt={title}
      src={imgSrc}
